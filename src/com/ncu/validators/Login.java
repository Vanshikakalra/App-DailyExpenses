...
public class Login{
	...
	try{
		input=new FileInputStream("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\configs\\constants\\login.properties");  //opened filed in input format to read username and password from login properties file
		//input2=new FileInputStream("C:\\Users\\VANSKALRA\\Desktop\\Java\\src\\password.properties");
		input3=new FileInputStream("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\configs\\constants\\exceptions.properties"); //opened filed in input format to read username and password from exceptions properties file
		//prop2.load(input2);
...
p=prop.getProperty("password"); //called getProperty method of propeerties class to read specific key
      ...
      if(pass.equals(null))
      {
		...
		if((u.equals(username))&&(p.equals(pass))) //checking conditon for correct ceredemnials
		{
