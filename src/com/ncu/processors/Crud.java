...
public class Crud{
	...
	FileWriter writer=null;	//FileWriter class object declared
		...
		{   try   {              
		         FileWriter fr=new FileWriter("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\TextFile\\daily_expenses.txt",true); //oppend file in filewriter and append mode to write data 
...
Properties prop=new Properties(); //created object of propertyy file
            ...
            try { 
                         ...
                         fis=new FileInputStream("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\configs\\constants\\exceptions.properties"); //for reading from property file
                   inFile = new File("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\TextFile\\daily_expenses.txt"); //passed original file path  
                   file=new File("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\TextFile\\temp.txt"); //constructed new temporary file
                   prop.load(fis);
...
Properties prop=new Properties(); //created object of propertyy file
            ...
            try {  
                  ...
                  fi=new FileInputStream("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\configs\\constants\\exceptions.properties"); //for reading from property file
  ...
  public float calculatetotalexpense()
		{int sum=0;
		try{	input= new FileReader("C:\\Users\\VANSKALRA\\Desktop\\UnguidedProject\\TextFile\\daily_expenses.txt");//for reading from the original file
